 ...
 *      因此数组元素应该存 在字符流中的位置
 */
public class code54_FirstAppearOnceInStream {
    private int[] arr = new int[256];

    // TODO 必须使用index表示字符流输入的字符个数
    private int index;

    public code54_FirstAppearOnceInStream() {
    ...
    public static void main(String[] args) {
        ...
        code54_FirstAppearOnceInStream firstAppearOnceInStream = new code54_FirstAppearOnceInStream();
