...
/*
	搜索二叉树：
		不具有平衡性
1. 查询：
	头节点的左子树都比当前节点小，右子树都比当前节点大
2. 插入：
	先从头节点往下，找到可以插入的父节点位置
	插入，如果父节点>插入节点，则挂在左边，否则挂在右边
3. 删除：
	如果一个节点没有左孩子或者右孩子，要删除该节点的话，直接将其左/右孩子顶替删除节点的位置
	如果一个节点左右孩子都存在，要删除该节点的话，需要设计：将右子树最左的节点顶替删除节点的位置
 */
...
public class AbstractBinarySearchTree {
	 ...
	 */
	// TODO 搜索二叉树的查询：头节点的左子树都比当前节点小，右子树都比当前节点大
	 ...
	 */
	// TODO 搜索二叉树的删除节点
	// TODO 1. 如果一个节点没有左孩子或者右孩子，要删除该节点的话，直接将其左/右孩子顶替删除节点的位置
	// TODO 2. 如果一个节点左右孩子都存在，要删除该节点的话，需要设计：将右子树最左的节点顶替删除节点的位置
